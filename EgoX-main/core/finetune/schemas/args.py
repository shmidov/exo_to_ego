...
class Args(BaseModel):
    ...
    model_path: Path
    model_name: str
    model_type: Literal["i2v", "t2v", "i2pm", "i2dpm", "wan-i2v", "wan-t2v"]
    ...
    def parse_args(cls):
        ...
        # IC-LoRA specific columns
        parser.add_argument("--exo_video_column", type=str, default=None)
        parser.add_argument("--ego_gt_video_column", type=str, default=None)
        ...
        # IC-LoRA specific validation columns
        parser.add_argument("--validation_exo_videos", type=str, default=None)
        parser.add_argument("--validation_ego_prior_videos", type=str, default=None)
